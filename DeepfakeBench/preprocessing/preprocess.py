...
if __name__ == '__main__':
    ...
    ## DeepFakeDetection
        ...
        sub_dataset_names = ['DFD_original sequences', 'DFD_manipulated_sequences']
   ...
   ## DeeperForensics-1.0
    ...
    ## FFIW
        ...
        sub_dataset_names = ['source/train', 'source/val', 'target/train', 'target/val']
        sub_dataset_paths = [Path(os.path.join(dataset_path, name)) for name in sub_dataset_names]
    else:
    ...
    if 'sub_dataset_paths' in globals() and len(sub_dataset_paths) != 0:
        ...
        for sub_dataset_path in sub_dataset_paths:
            ...
            # FFIW: target/train → target_mask/train, target/val → target_mask/val
            if dataset_name == 'FFIW' and 'target' in str(sub_dataset_path):
                mask_dataset_path = os.path.join(dataset_path, str(sub_dataset_path).replace('target', 'target_mask'))
